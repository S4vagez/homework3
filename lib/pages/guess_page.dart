    ...
    return Padding(
      ...
      child: InkWell(
          ...
          child: Container(
            ...
            child: Image.asset('image/x.png', width: 25.0, color: Colors.purple),
          )
      ),
    );
  }
    ...
    return Padding(
      ...
      child: InkWell(
          ...
          child: Container(
            ...
            child: Image.asset('image/delete.png', width: 25.0, color: Colors.purple),
          )
      ),
    );
  }
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Image.asset('image/guess_logo.png', width: 90.0),
                SizedBox(width: 10.0),
                Column(
                  children: [
                    Text('GUESS',
